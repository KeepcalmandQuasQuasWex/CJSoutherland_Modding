 ...
 *
 */
public class ChaosMeteor extends Item {
  ...
  public ChaosMeteor() {
    ...
    setUnlocalizedName("Chaosmeteor");
  }
  ...
  public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer)
  {
	  if(!par3EntityPlayer.capabilities.isCreativeMode) {
	      ...
	      {
			  par2World.spawnEntityInWorld(new BiggerBetterEntityBlasterBolt(par2World, par3EntityPlayer));
